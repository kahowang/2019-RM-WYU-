#ifndef _ROS_skyguard_msgs_RawVelocities_h
#define _ROS_skyguard_msgs_RawVelocities_h
...
namespace skyguard_msgs
{
  ...
  class RawVelocities : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "skyguard_msgs/RawVelocities"; };
